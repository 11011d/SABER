...
class CloudVolume:
  def __new__(cls,
    ...
    timestamp:Optional[int] = None, log_path = "/dev/shm", partial_decompress_parallel = None,
    cache_thread = None, l2cache_size = 0, use_compressed_block=False,
  ):
    """
    ...
    Optional:
      ...
      partial_decompress_parallel: (int) if partial_decompress_parallel is not None,
        use partial decompress parallel to speedup(num of threads equals to partial_decompress_parallel)
    """
    if use_https:
