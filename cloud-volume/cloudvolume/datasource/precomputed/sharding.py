...
class ShardReader(object):
  ...
  def get_indices(self, filenames, path="", progress=None):
    ...
    binaries, cacheserver_info = self.cache.download_as(requests, progress=progress)
  ...
  def get_minishard_indices_for_files(self, requests, path="", progress=None):
    ...
    results, cacheserver_info = self.cache.download_as(download_requests, progress=progress)
    ...
    get_minishard_indices_info['get_minishard_indicesdownload_as_cache_get_time'] = cacheserver_info['download_as_cache_get_time']
    get_minishard_indices_info['get_minishard_indicesdownload_as_cache_put_time'] = cacheserver_info['download_as_cache_put_time']
    get_minishard_indices_info['get_minishard_indicesdownload_as_cache_hit_num'] = cacheserver_info['download_as_cache_hit_num']
    get_minishard_indices_info['get_minishard_indicesdownload_as_cache_miss_num'] = cacheserver_info['download_as_cache_miss_num']
    get_minishard_indices_info['get_minishard_indicesdownload_as_remote_time'] = cacheserver_info['download_as_remote_time']
    get_minishard_indices_info['get_minishard_indicesdownload_as_remote_size'] = cacheserver_info['download_as_remote_size']
  ...
  def exists(self, labels, path="", return_byte_range=False, progress=None):
    ...
    start_time = time.time()
    indices, get_indices_info = self.get_indices(to_all_labels.keys(), path, progress=progress)
  ...
  def get_data(
    ...
    raw:bool = False, cache_thread = None,
  ):
    ...
    exists, exist_info = self.exists(label, path, return_byte_range=True, progress=progress)
    ...
    if return_multiple:
      return results, get_data_info
    return first(results.values()), get_data_info
