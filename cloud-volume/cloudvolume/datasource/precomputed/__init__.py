...
def create_precomputed(
    ...
    **kwargs # absorb graphene arguments
    ...
    cv = CloudVolumePrecomputed(
      ...
      image, mesh, skeleton,
      mip, log_path = kwargs['log_path'], 
      partial_decompress_parallel = kwargs['partial_decompress_parallel'],
      l2cache_size = kwargs['l2cache_size'],
      use_compressed_block = kwargs['use_compressed_block'],
      cache_thread = kwargs['cache_thread'],
    )
